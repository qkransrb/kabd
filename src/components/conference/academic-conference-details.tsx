...
const AcademicConferenceDetails = ({ id, conference }: Props) => {
  return (
    <div>
      ...
      <Separator className="h-[2px] lg:h-[3px] bg-black mb-[30px] lg:mb-[110px]" />
      <div className="flex flex-col items-center">
        <div className="mb-[50px] lg:mb-[90px]">
          <img
        ...
        <Link
          href="/conference"
          className="w-[108px] h-[50px] rounded-[10px] bg-[#DFDFDF] flex items-center justify-center mb-[100px] lg:mb-[200px]"
        >
