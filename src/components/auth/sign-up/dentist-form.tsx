...
const formSchema = z
  .object({
    ...
    major: z.array(z.string()).refine((value) => value.some((item) => item), {
...
export type DentistSignUp = z.infer<typeof formSchema>;
                  ...
                  <FormItem className="h-full flex items-center px-2 lg:px-[22px]">
                    ...
                    >
                      ...
                      <SelectContent className="text-xs lg:text-base font-medium custom-letter-spacing">
                        ...
                        <SelectItem value="단국대학교">단국대학교</SelectItem>
                        <SelectItem value="부산대학교">부산대학교</SelectItem>
                        <SelectItem value="서울대학교">서울대학교</SelectItem>
                        <SelectItem value="연세대학교">연세대학교</SelectItem>
                        <SelectItem value="원광대학교">원광대학교</SelectItem>
                        <SelectItem value="전남대학교">전남대학교</SelectItem>
                        <SelectItem value="전북대학교">전북대학교</SelectItem>
                        <SelectItem value="조선대학교">조선대학교</SelectItem>
              ...
              <FormField
                ...
                render={() => (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      {majors.map((major) => (
                        <DropdownMenuItem key={major.id} className="w-[208px]">
                          <FormField
                            key={major.id}
                            control={form.control}
                            name="major"
